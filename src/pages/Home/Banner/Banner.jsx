...
const Banner = () => {
  return (
    <div className="carousel w-full h-2/5 mt-20 ">
      <div id="slide1" className="carousel-item relative w-full " data-aos="fade-up" data-aos-duration="2000">
      ...
      <div id="slide2" className="carousel-item relative w-full " data-aos="fade-up" data-aos-duration="2000" >
      ...
      <div id="slide3" className="carousel-item relative w-full " data-aos="fade-up" data-aos-duration="2000">
      ...
      <div id="slide4" className="carousel-item relative w-full " data-aos="fade-up" data-aos-duration="2000">
